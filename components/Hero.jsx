	...
	return (
		<section className='bg-blue-700 py-20 mb-4'>
			<div className='max-w7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center'>
				...
				{/* <form className='mt-3 mx-auto gap-4 max-w-2xl w-full flex flex-col md:flex-row items-center'>
					<div className='w-full md:w-3/5 md:pr-2 md-4 md:mb-0'>
						...
						<input
							type='text'
							id='location'
							placeholder='Enter Location (City, State,Zip, e.t.c)'
							className='w-full px-4 py-3 rounded-lg bg-white text-gray-800 focus:outline-none focus:ring
                    focus:ring-blue-500'
						/>
					</div>
					<div className='w-full md:w-2/5md:pl-2'>
						<label htmlFor='property-type' className='sr-only'>
							Property Type
						</label>
						<select
							id='property-type'
							className='w-full px-4 py-5 h-10 rounded-lg bg-white text-gray-800 focus:outline-none focus:ring focus:ring-blue-500'
						>
